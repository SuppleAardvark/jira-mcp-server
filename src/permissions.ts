...
export const SCOPES = {
  ...
  'issues:read': ['jira_get_issue', 'jira_search_issues', 'jira_get_transitions', 'jira_get_issue_history', 'jira_get_backlog_stats', 'jira_get_field_schema', 'jira_get_create_fields', 'jira_list_field_values'],
